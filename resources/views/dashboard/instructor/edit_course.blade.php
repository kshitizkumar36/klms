  ...
  <div class="page-content fade">
    ...
    <div class="page-header">
      <div>
        ...
        <h1>Complete Fullstack Web Development Mastery</h1>
      </div>
      <div style="display:flex; gap:10px;">
        <button class="btn-secondary" onclick="window.open('#','_blank')">👁 View Live Page</button>
      </div>
    </div>
      ...
      <div class="form-card">
        <div class="row">
          <div class="col">
            ...
            <input type="text" value="Complete Fullstack Web Development Mastery" />
          </div>
        </div>
        ...
        <div class="row">
          <div class="col">
            ...
            <textarea rows="2">Become a full-stack web developer with just one course. HTML, CSS, Javascript, Node, React, MongoDB and more!</textarea>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col">
            ...
            <textarea rows="6">This course is designed to take you from absolute beginner to competent full-stack developer. We cover the MERN stack in depth...</textarea>
          </div>
        </div>
      </div>
      ...
      <div class="form-card">
        ...
        <div class="curriculum-item">
          ...
          <div class="curr-body">
            ...
            <div class="lesson-row">
              <span>🎥</span> <input type="text" value="How the web works" style="border:none; background:transparent; padding:0;" />
            </div>
        ...
        <div class="curriculum-item">
          <div class="curr-header">
            <span style="font-weight:600;">Section 2: HTML 5 Basics</span>
            <span style="font-size:12px; color:var(--muted);">5 Lectures</span>
          </div>
          <div class="curr-body">
             <button class="btn-add">+ Add Lecture</button>
          </div>
      ...
      <div class="form-card">
        <div class="row">
          <div class="col">
            ...
            <img src="https://picsum.photos/400/250" class="thumb-preview" />
            <button class="upload-btn-small">Change Image</button>
          </div>
          <div class="col">
            <label>Promotional Video</label>
            <div style="background:#000; height:200px; display:flex; align-items:center; justify-content:center; border-radius:12px; border:1px solid var(--border); margin-bottom:10px;">
              <span style="color:var(--muted);">▶ Video Preview</span>
            </div>
            <button class="upload-btn-small">Change Video</button>
          </div>
        </div>
      </div>
      <div class="action-bar">
    ...
    <div id="price" class="section">
      ...
      <div class="action-bar">
        ...
        <button class="btn-primary" style="background:#198754;">✔ Update Course</button>
      </div>
    </div>
